    ...
    B: Backend,
{
    ...
    fn render(&self, frame: &mut Frame<B>, area: Rect, session: &Session, system: &System);
    fn handle_event(&self, event: &Key, session: &Session, system: &System);
}
...
where
    B: Backend,
{
    vec![Box::new(allocation::View::new())]
    // vec![
    //     View {
